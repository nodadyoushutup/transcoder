...
@shared_task(
    ...
    name="core.api.src.celery_app.tasks.library.refresh_plex_sections_snapshot",
)
...
@shared_task(
    ...
    name="core.api.src.celery_app.tasks.library.fetch_section_snapshot_chunk",
)
...
@shared_task(
    ...
    queue=LIBRARY_SECTION_QUEUE,
    name="core.api.src.celery_app.tasks.library.build_section_snapshot_task",
)
...
@shared_task(
    ...
    name="core.api.src.celery_app.tasks.library.cache_single_image_task",
    ignore_result=False,
)
...
@shared_task(
    ...
    default_retry_delay=45,
    queue=IMAGE_CACHE_QUEUE,
    name="core.api.src.celery_app.tasks.library.cache_section_images_task",
)
