...
celery.set_default()
celery.conf.beat_scheduler = "core.api.src.celery.scheduler.SettingsBackedScheduler"
...
def _configure_routes(default_queue: str, library_queue: str, image_cache_queue: str) -> None:
    ...
    routes["core.api.src.celery.tasks.library.build_section_snapshot_task"] = {"queue": library_queue}
    routes["core.api.src.celery.tasks.library.fetch_section_snapshot_chunk"] = {"queue": library_queue}
    routes["core.api.src.celery.tasks.library.cache_section_images_task"] = {"queue": image_cache_queue}
    routes["core.api.src.celery.tasks.library.cache_single_image_task"] = {"queue": image_cache_queue}
...
def init_celery(app: Flask | None = None) -> Celery:
    ...
    celery.autodiscover_tasks(["core.api.src.celery.tasks"])
